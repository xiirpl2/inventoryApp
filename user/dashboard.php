...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row " style="padding-top: 4rem;">
        ...
        <div class="col-md-9 text-end"><i class="bi bi-house-door-fill"></i><a href="dashboard.html" style="text-decoration: none; color: black"> home</a></div>
      </div>
    </div>
    <div class="container">
      <div class="row">
  ...
  <div class="row">
    <div class="col-md-6 text-center mb-3">
      <button type="button" class="btn btn-primary btn-lg">Data Alat-Alat</button>
    </div>
    <div class="col-md-6 text-center mb-3">
      <button type="button" class="btn btn-primary btn-lg">Data Peminjaman Alat</button>
    </div>
    <!-- <div class="col-md-4">
